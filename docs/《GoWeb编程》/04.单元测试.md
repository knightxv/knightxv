---
title: 单元测试
date: 2023-01-19 20:50:28
permalink: /pages/24a0ae/
categories:
  - 《Web编程》笔记
tags:
  - 
...
split $ go test
PASS
ok      github.com/knightxv/studygo/code_demo/test_demo/split       0.005s
```
...
FAIL
exit status 1
FAIL    github.com/knightxv/studygo/code_demo/test_demo/split       0.006s
```
...
FAIL
exit status 1
FAIL    github.com/knightxv/studygo/code_demo/test_demo/split       0.005s
```
...
PASS
ok      github.com/knightxv/studygo/code_demo/test_demo/split       0.006s
```
...
goos: darwin
goarch: amd64
pkg: github.com/knightxv/studygo/code_demo/test_demo/split
BenchmarkSplit-8        10000000               203 ns/op
PASS
ok      github.com/knightxv/studygo/code_demo/test_demo/split       2.255s
```
...
PASS
ok      github.com/knightxv/studygo/code_demo/test_demo/split       2.394s
```
...
PASS
ok      github.com/knightxv/studygo/code_demo/test_demo/split       1.423s
```
...
goos: darwin
goarch: amd64
pkg: github.com/knightxv/studygo/code_demo/test_demo/fib
...
PASS
ok      github.com/knightxv/studygo/code_demo/test_demo/fib 12.944s
```
...
PASS
ok      github.com/knightxv/studygo/code_demo/test_demo/fib 33.849s
```
...
PASS
ok      github.com/knightxv/studygo/code_demo/test_demo/split       3.308s
```
